            ...
            <div class="row">
                <div class="col-xl-2 col-lg-2 menu_column">
                    ...
                    <div class="menu_user">
                        ...
                        <a href="/area-usuario"><li class="menu_user_item active "><i class="far fa-address-card "></i> Inicio</li></a>
                        ...
                        <div class="row fila_1_user">
                            <div class="col-xl-12 col-lg-8">
                                <div class="row">
                                    ...
                                    <div class="col-xl-5 offset-xl-1 offset-lg-1 col-lg-4 col-sm-4 col-12 asesor_column">
                                        <div class="row ">
                                            ...
                                            <div class="col-12 col-xl-6 col-sm-12 col-lg-12 my-auto textos_asesor">
                                                ...
                                                <div class="botonera_asesor">
                                                    ...
                                                    <a href="mailto:juanma.vales@icecream.mk" class="asesor_email">Enviar
                                                        email</a>
                                                    <a href="tel:913688604" class="asesor_telefono">Llamar</a>
                                ...
                                <div class="row segunda_user">
                                    <div class="col-xl-5 col-lg-4 col-sm-4 col-12 column_cumple">
                                    ...
                                    <div class="col-xl-5 offset-xl-1 offset-lg-1 col-lg-4 col-sm-4 col-12">
                                        <div class="row tarjeta_cumple">
                                            <div class="col-3"><img
